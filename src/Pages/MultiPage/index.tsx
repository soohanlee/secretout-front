...
const MultiDevicePage = () => {
  ...
  return (
    <>
      <BackButtonWithText />
      <PlayGameLayout>
        <div className='flex pb-8 flex-col text-center'>
          <div className=''>방을 먼저 생성해요.</div>
          <div>방을 만드는 사람의 이름을 입력해주세요.</div>
        </div>
        <div className='flex items-center justify-center gap-6 py-5 mb-6'>
          <input
            className='p-2 border-b w-full border-black place-content-center text-center'
            type='text'
            placeholder='ex) 이수한'
            value={players}
        ...
        <BottomComponent>
          <BaseButton className='w-full' onClick={createMultiRoom}>
            방 만들기
          </BaseButton>
        </BottomComponent>
      </PlayGameLayout>
